...
export default function FuturisticSHEETU() {
  ...
  useEffect(() => {
    if (typeof window !== "undefined") {
      const savedApiKeys = localStorage.getItem("SHEETU-api-keys")
      if (savedApiKeys) {
        try {
  ...
  const handleSaveApiKey = useCallback(() => {
    ...
    localStorage.setItem("SHEETU-api-keys", JSON.stringify(updatedApiKeys))
          ...
          >
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center space-x-2 sm:space-x-3 flex-shrink-0">
                ...
                >
                  <a
                    href="https://github.com/RS-labhub/SHEETU"
                    target="_blank"
                    rel="noopener noreferrer"
                  ...
                  <div className="flex-1">
                    ...
                    >
                      <div className="flex items-center space-x-2">
                        ...
                        >
                          {uiStyle === "pixel" ? "SHEETU IS PROCESSING..." : "SHEETU is thinking..."}
                        </span>
                      </div>
                    </div>
                  </div>
